...
ant -buildfile buildCDT.xml %target% -Dinstall=%install% -Dos=%os% -Dws=%ws% -Dbootclasspath=%bootclasspath%
goto end

:rundefault
ant -buildfile buildCDT.xml %target% -Dos=%os% -Dws=%ws% -Dbootclasspath=%bootclasspath%
goto end
