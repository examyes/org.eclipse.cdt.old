...
public class NewCDTProjectPage extends WizardNewProjectCreationPage {
	...
	public NewCDTProjectPage(String pageName) {
		super(pageName);
	}
	...
	public void createControl(Composite parent) {
		...
		setMessage("Specify name, location, and build system for this project.");
		
		Group buildSystemGroup = new Group(composite, SWT.NONE);
		...
		final List buildSystems = new List(buildSystemGroup, SWT.SINGLE);
