...
public class SessionsProcessor extends XMLProcessor {
	...
	private static final String _SESSION_CTR_ATTR = "counter"; //$NON-NLS-1$
	...
	public void startElement(String name, Attributes attrs, Object callData) {
		if (name.equals(SESSION_TAG)) {
			...
			int counter = Integer.parseInt(attrs.getValue(_SESSION_CTR_ATTR));
			_currentSession = new SampleSession(counter, file);
