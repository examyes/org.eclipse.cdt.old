...
public class WinDbgLocator extends WinDbgLocation implements ICDILocator {

	public WinDbgLocator(String file, String function, int lineNumber,
			BigInteger address) {
		super(file, function, lineNumber, address);
	}
