...
public class Connection implements IDomainListener
{
	...
	public Connection(String name, String host, String port, String type, String dir, boolean isLocal, boolean isUsingDaemon, DataElement parent)
	{
		_name = name;
		_host = host;
		_port = port;
	...
	{
		String result = new String(_name + " " + _type + " " + _host + " " + _port + " " + _dir + " " + _local + " " + _useDaemon);
		return result;
	}
