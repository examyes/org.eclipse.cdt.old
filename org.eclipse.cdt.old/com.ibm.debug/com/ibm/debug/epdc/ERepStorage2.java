...
//
// com/ibm/debug/epdc/ERepStorage2.java, java-epdc, eclipse-dev, 20011128
// Version 1.5.1.2 (last modified 11/28/01 16:26:17)
////////////////////////////////////////////////////////////////////////////////
...
/**
 * Monitor storage2 reply -- only contains reply header
 */
public class ERepStorage2 extends EPDC_Reply {
  ...
  //Decode EPDC reply
  ERepStorage2(byte[] packetBuffer, DataInputStream dataInputStream)
  throws IOException
  {
