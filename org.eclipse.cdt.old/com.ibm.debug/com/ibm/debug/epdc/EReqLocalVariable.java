...
//
// com/ibm/debug/epdc/EReqLocalVariable.java, java-epdc, eclipse-dev, 20011128
// Version 1.7.1.2 (last modified 11/28/01 16:24:16)
////////////////////////////////////////////////////////////////////////////////
...
public class EReqLocalVariable extends EPDC_Request {
    ...
    */
   protected EReqLocalVariable (byte[] inBuffer) throws IOException {
      super(inBuffer);
   ...
   public EReqLocalVariable(int threadID, int stackEntryNumber)
   {
      super(EPDC.Remote_LocalVariable);
