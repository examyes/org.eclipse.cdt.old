...
//
// com/ibm/debug/epdc/ERepGetProcessColumns.java, java-epdc, eclipse-dev, 20011128
// Version 1.5.1.2 (last modified 11/28/01 16:24:50)
////////////////////////////////////////////////////////////////////////////////
...
/**
 * ERepGetProcessColumns EPDC structure.  Used by ERepProcessDetailsGet.
 */
public class ERepGetProcessColumns extends EPDC_Base {

   ERepGetProcessColumns(int columnID, String columnName, int columnNameAlignment, int columnTextAlignment) {
      _columnID = columnID;
   ...
   public ERepGetProcessColumns(byte[] packetBuffer, DataInputStream dataInputStream)
   throws IOException
   {
      ...
      if (columnNameOffset != 0)
         _columnName = new EStdString(new OffsetDataInputStream(packetBuffer, columnNameOffset));
   }
