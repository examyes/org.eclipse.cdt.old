...
//
// com/ibm/debug/epdc/ERepPartSet.java, java-epdc, eclipse-dev, 20011128
// Version 1.5.1.2 (last modified 11/28/01 16:23:44)
////////////////////////////////////////////////////////////////////////////////
...
/**
 * Part set reply -- empty packet body
 */
public class ERepPartSet extends EPDC_Reply {

   public ERepPartSet() {
      super(EPDC.Remote_PartSet);
   }

  protected ERepPartSet(byte[] packetBuffer, DataInputStream dataInputStream)
  throws IOException
  {
