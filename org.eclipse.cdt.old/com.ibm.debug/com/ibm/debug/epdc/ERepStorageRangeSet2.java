...
//
// com/ibm/debug/epdc/ERepStorageRangeSet2.java, java-epdc, eclipse-dev, 20011128
// Version 1.3.1.2 (last modified 11/28/01 16:26:21)
////////////////////////////////////////////////////////////////////////////////
...
/**
 * Monitor storageRangeSet2 reply -- only contains reply header
 */
public class ERepStorageRangeSet2 extends EPDC_Reply {

   public ERepStorageRangeSet2() {
      super(EPDC.Remote_StorageRangeSet2);
   }

  //Decode EPDC reply
  ERepStorageRangeSet2(byte[] packetBuffer, DataInputStream dataInputStream)
  throws IOException
  {
