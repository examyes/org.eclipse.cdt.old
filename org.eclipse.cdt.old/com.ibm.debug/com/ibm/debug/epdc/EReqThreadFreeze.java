...
//
// com/ibm/debug/epdc/EReqThreadFreeze.java, java-epdc, eclipse-dev, 20011128
// Version 1.4.1.2 (last modified 11/28/01 16:24:31)
////////////////////////////////////////////////////////////////////////////////
...
/**
 * ThreadFreeze Program Request.
 */
public class EReqThreadFreeze extends EPDC_Request
{
   public EReqThreadFreeze(int DU)
   {
    super(EPDC.Remote_ThreadFreeze);
    _DU = DU;
   }
   ...
   /**
     * Constructs a new EReqThreadFreeze object
     */
    EReqThreadFreeze(byte[] inBuffer) throws IOException {
   super (inBuffer);
   _DU = readInt();
    }
   ...
   /**
     * Return the thread DU number for this EReqThreadFreeze
     */
    public int getDU() {
   return _DU;
    }
