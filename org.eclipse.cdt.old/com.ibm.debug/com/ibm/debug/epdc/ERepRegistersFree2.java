...
//
// com/ibm/debug/epdc/ERepRegistersFree2.java, java-epdc, eclipse-dev, 20011128
// Version 1.2.1.2 (last modified 11/28/01 16:25:35)
////////////////////////////////////////////////////////////////////////////////
...
/**
 * Free registers reply -- only contains reply header
 */
public class ERepRegistersFree2 extends EPDC_Reply
{
   public ERepRegistersFree2()
   {
      super(EPDC.Remote_RegistersFree2);
   }

   //Decode EPDC reply
   ERepRegistersFree2(byte[] packetBuffer, DataInputStream dataInputStream)
   throws IOException
   {
