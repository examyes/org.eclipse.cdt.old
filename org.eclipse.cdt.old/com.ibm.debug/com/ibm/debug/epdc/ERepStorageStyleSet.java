...
//
// com/ibm/debug/epdc/ERepStorageStyleSet.java, java-epdc, eclipse-dev, 20011128
// Version 1.3.1.2 (last modified 11/28/01 16:26:22)
////////////////////////////////////////////////////////////////////////////////
 ...
 */
public class ERepStorageStyleSet extends EPDC_Reply {

   public ERepStorageStyleSet() {
      super(EPDC.Remote_StorageStyleSet);
   }

  //Decode EPDC reply
  ERepStorageStyleSet(byte[] packetBuffer, DataInputStream dataInputStream)
  throws IOException
  {
