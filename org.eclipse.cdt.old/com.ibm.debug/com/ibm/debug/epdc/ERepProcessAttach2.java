...
//
// com/ibm/debug/epdc/ERepProcessAttach2.java, java-epdc, eclipse-dev, 20011128
// Version 1.6.1.2 (last modified 11/28/01 16:24:52)
////////////////////////////////////////////////////////////////////////////////
...
// !!! The implementation of this class is identical to ERepProcessAttach
// Should we simply extend from instead of duplicating code?

public class ERepProcessAttach2 extends EPDC_Reply {

   public ERepProcessAttach2(EPDC_EngineSession session, EStdTime timestamp,
   ...
   ERepProcessAttach2(byte[] packetBuffer, DataInputStream dataInputStream)
   throws IOException
   {
