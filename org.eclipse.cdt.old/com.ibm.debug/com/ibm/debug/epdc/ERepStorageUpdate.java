...
//
// com/ibm/debug/epdc/ERepStorageUpdate.java, java-epdc, eclipse-dev, 20011128
// Version 1.3.1.2 (last modified 11/28/01 16:26:23)
////////////////////////////////////////////////////////////////////////////////
...
/**
 * Monitor storageUpdate reply -- only contains reply header
 */
public class ERepStorageUpdate extends EPDC_Reply {

   public ERepStorageUpdate() {
      super(EPDC.Remote_StorageUpdate);
   }

  //Decode EPDC reply
  ERepStorageUpdate(byte[] packetBuffer, DataInputStream dataInputStream)
  throws IOException
  {
