...
//
// com/ibm/debug/epdc/ModuleChangeInfo.java, java-epdc, eclipse-dev, 20011128
// Version 1.4.1.2 (last modified 11/28/01 16:24:46)
////////////////////////////////////////////////////////////////////////////////
...
{
  ModuleChangeInfo(byte[] packetBuffer, DataInputStream dataInputStream)
  throws IOException
  {
    ...
    if (changeItemsInThisPacket() == 1)
      ...
      for (int i = 0; i < changeItemsInThisPacket(); i++)
      {
          ...
          addChangedItem(new ERepNextModuleEntry
                             (
                               packetBuffer,
