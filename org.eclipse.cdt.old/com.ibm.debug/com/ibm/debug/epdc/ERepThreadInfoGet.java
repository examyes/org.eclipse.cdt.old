...
//
// com/ibm/debug/epdc/ERepThreadInfoGet.java, java-epdc, eclipse-dev, 20011128
// Version 1.1.1.2 (last modified 11/28/01 16:26:07)
////////////////////////////////////////////////////////////////////////////////
 ...
 *
 */
public class ERepThreadInfoGet extends EPDC_Reply {

   public ERepThreadInfoGet() {
      super(EPDC.Remote_ThreadInfoGet);
   }

  protected ERepThreadInfoGet(byte[] packetBuffer, DataInputStream dataInputStream)
  throws IOException
  {
