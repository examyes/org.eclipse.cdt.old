...
//
// com/ibm/debug/model/EngineDaemonEventAdapter.java, java-model, eclipse-dev, 20011128
// Version 1.1.1.2 (last modified 11/28/01 16:14:15)
////////////////////////////////////////////////////////////////////////////////
...
public abstract class EngineDaemonEventAdapter
	   extends ModelEventAdapter // Get default implementations of getClient
								 // and filterEvents
	   implements EngineDaemonEventListener
{
   /**
   ...
   public EngineDaemonEventAdapter()
   {
   }
   /**
   ...
   public EngineDaemonEventAdapter(Client client)
   {
	 super(client);
   }
