...
//
// com/ibm/debug/model/DebugModelEventAdapter.java, java-model, eclipse-dev, 20011128
// Version 1.2.1.2 (last modified 11/28/01 16:13:51)
////////////////////////////////////////////////////////////////////////////////
...
public abstract class DebugModelEventAdapter
       extends ModelEventAdapter // Get default implementations of getClient
                                 // and filterEvents
       implements DebugModelEventListener
{
   /**
   ...
   public DebugModelEventAdapter(Client client)
   {
     super(client);
   }
   ...
   public DebugModelEventAdapter()
   {
   }

   public void hostAdded(HostAddedEvent event)
   {
   }
}
