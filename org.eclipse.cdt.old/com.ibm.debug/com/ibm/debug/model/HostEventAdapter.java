...
//
// com/ibm/debug/model/HostEventAdapter.java, java-model, eclipse-dev, 20011128
// Version 1.2.1.2 (last modified 11/28/01 16:13:56)
////////////////////////////////////////////////////////////////////////////////
...
public abstract class HostEventAdapter
       extends ModelEventAdapter // Get default implementations of getClient
                                 // and filterEvents
       implements HostEventListener
{
   /**
   ...
   public void debugEngineAdded(DebugEngineAddedEvent event)
   {
   }
}
