...
//
// com/ibm/debug/model/ModuleEventAdapter.java, java-model, eclipse-dev, 20011128
// Version 1.2.1.2 (last modified 11/28/01 16:12:04)
////////////////////////////////////////////////////////////////////////////////
...
public abstract class ModuleEventAdapter
       ...
       implements ModuleEventListener
{
   ...
   public ModuleEventAdapter(Client client)
   {
     super(client);
   }
