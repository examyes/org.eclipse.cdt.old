...
//
// com/ibm/debug/model/EngineGeneralCapabilities.java, java-model, eclipse-dev, 20011128
// Version 1.7.1.2 (last modified 11/28/01 16:12:14)
////////////////////////////////////////////////////////////////////////////////
...
{
  EngineGeneralCapabilities(EFunctCustTable FCTBits)
  {
    super(FCTBits);
  }
  ...
  public boolean isSameAs(EngineGeneralCapabilities capabilities)
  {
  ...
  public void print(PrintWriter printWriter)
  {
    if (Model.includePrintMethods)
    {
       ...
       printWriter.println("  Multiple Threads Supported=" +
                           (multipleThreadsSupported() ? "true" : "false"));
    }
  }
}
