...
//
// com/ibm/debug/model/DebuggeeThreadEventAdapter.java, java-model, eclipse-dev, 20011128
// Version 1.5.1.2 (last modified 11/28/01 16:12:03)
////////////////////////////////////////////////////////////////////////////////
...
public abstract class DebuggeeThreadEventAdapter
       extends ModelEventAdapter // Get default implementations of getClient
                                 // and filterEvents
       implements DebuggeeThreadEventListener
{
   /**
   ...
   public DebuggeeThreadEventAdapter(Client client)
   {
     super(client);
   }
   ...
   public DebuggeeThreadEventAdapter()
   {
   }
