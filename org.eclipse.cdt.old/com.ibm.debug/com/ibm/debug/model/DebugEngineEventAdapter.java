...
//
// com/ibm/debug/model/DebugEngineEventAdapter.java, java-model, eclipse-dev, 20011128
// Version 1.6.1.2 (last modified 11/28/01 16:12:01)
////////////////////////////////////////////////////////////////////////////////
...
public abstract class DebugEngineEventAdapter
       extends ModelEventAdapter // Get default implementations of getClient
                                 // and filterEvents
       implements DebugEngineEventListener
{
   /**
   ...
   public DebugEngineEventAdapter(Client client)
   {
     super(client);
   }
   ...
   public DebugEngineEventAdapter()
   {
   }
