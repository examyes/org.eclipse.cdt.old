...
//
// com/ibm/debug/model/BreakpointEventAdapter.java, java-model, eclipse-dev, 20011128
// Version 1.2.1.2 (last modified 11/28/01 16:12:00)
////////////////////////////////////////////////////////////////////////////////
...
public abstract class BreakpointEventAdapter
       extends ModelEventAdapter // Get default implementations of getClient
                                 // and filterEvents
       implements BreakpointEventListener
{
   /**
   ...
   public BreakpointEventAdapter(Client client)
   {
     super(client);
   }
