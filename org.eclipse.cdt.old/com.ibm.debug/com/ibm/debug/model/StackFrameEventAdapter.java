...
//
// com/ibm/debug/model/StackFrameEventAdapter.java, java-model, eclipse-dev, 20011128
// Version 1.2.1.2 (last modified 11/28/01 16:12:52)
////////////////////////////////////////////////////////////////////////////////
...
public abstract class StackFrameEventAdapter
       extends ModelEventAdapter // Get default implementations of getClient
                                 // and filterEvents
       implements StackFrameEventListener
{
   /**
   ...
   public StackFrameEventAdapter(Client client)
   {
     super(client);
   }
