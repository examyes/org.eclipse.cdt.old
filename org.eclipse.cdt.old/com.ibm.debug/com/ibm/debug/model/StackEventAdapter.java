...
//
// com/ibm/debug/model/StackEventAdapter.java, java-model, eclipse-dev, 20011128
// Version 1.4.1.2 (last modified 11/28/01 16:12:28)
////////////////////////////////////////////////////////////////////////////////
...
public abstract class StackEventAdapter
       extends ModelEventAdapter // Get default implementations of getClient
                                 // and filterEvents
       implements StackEventListener
{
   /**
   ...
   public StackEventAdapter(Client client)
   {
     super(client);
   }
