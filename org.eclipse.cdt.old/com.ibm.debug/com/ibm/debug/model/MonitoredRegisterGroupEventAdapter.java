...
//
// com/ibm/debug/model/MonitoredRegisterGroupEventAdapter.java, java-model, eclipse-dev, 20011128
// Version 1.2.1.2 (last modified 11/28/01 16:12:59)
////////////////////////////////////////////////////////////////////////////////
...
public abstract class MonitoredRegisterGroupEventAdapter
       extends ModelEventAdapter // Get default implementations of getClient
                                 // and filterEvents
       implements MonitoredRegisterGroupEventListener
{
   /**
   ...
   public MonitoredRegisterGroupEventAdapter(Client client)
   {
     super(client);
   }
   ...
   public MonitoredRegisterGroupEventAdapter()
   {
   }
