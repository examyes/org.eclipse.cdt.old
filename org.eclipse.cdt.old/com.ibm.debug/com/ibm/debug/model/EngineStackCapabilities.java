...
//
// com/ibm/debug/model/EngineStackCapabilities.java, java-model, eclipse-dev, 20011128
// Version 1.6.1.2 (last modified 11/28/01 16:12:21)
////////////////////////////////////////////////////////////////////////////////
...
public class EngineStackCapabilities extends EngineCapabilitiesGroup
{
  EngineStackCapabilities(EFunctCustTable FCTBits)
  {
    super(FCTBits);
  }
  ...
  public boolean isSameAs(EngineStackCapabilities capabilities)
  {
  ...
  int getBits()
  {
    return getFCTBits().getStackCapabilities();
  }
  ...
  public void print(PrintWriter printWriter)
  {
    ...
    {
       printWriter.println("Engine Stack Capabilities:");
    }
  }
}
