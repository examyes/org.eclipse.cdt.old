...
//
// com/ibm/debug/util/TraceLogger.java, java-util, eclipse-dev, 20011129a
// Version 1.7 (last modified 11/29/01 15:41:00)
////////////////////////////////////////////////////////////////////////////////
...
public final class TraceLogger extends Object
{
   ...
   */
    ...
    * and after the code to be checked.
   ...
   */
   ...
   private final void initXml()
   {
       ...
       xmlLog.println("         clientuserid=\"" +userName +"\"  clienthostname=\"???\" ");
...
//###############################################################################
    ...
    private static int     eventLevel   = 0;    // 0 for production
    private static int     debugLevel   = 0;    // 0 for production (not used)
    private static boolean    timings   = false;
  /** compile time static to enable/exclude 'msg' user message function/code */
    public static final boolean MSG            =true;   // true always
