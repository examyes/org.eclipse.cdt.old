...
//
// com/ibm/debug/internal/picl/StepIntoRequest.java, eclipse, eclipse-dev, 20011128
// Version 1.6 (last modified 11/28/01 15:59:23)
////////////////////////////////////////////////////////////////////////////////
...
public class StepIntoRequest extends StepRequest {
     ...
     */
    public StepIntoRequest(PICLDebugTarget debugTarget, PICLThread threadContext, ViewInformation viewInformation) {
    ...
    public void execute() throws PICLException {
    	...
    	try {
	    	fThreadContext.fDebuggeeThread.stepInto(fViewInformation,asyncRequest(), this);
