...
//
// com/ibm/debug/internal/picl/StepDebugRequest.java, eclipse, eclipse-dev, 20011128
// Version 1.5 (last modified 11/28/01 15:59:22)
////////////////////////////////////////////////////////////////////////////////
...
public class StepDebugRequest extends StepRequest {

    /**
     * Constructor for StepDebugRequest
     */
    public StepDebugRequest(PICLDebugTarget debugTarget, PICLThread threadContext, ViewInformation viewInformation) {
    ...
    public void execute() throws PICLException {
    	...
    	try {
	    	fThreadContext.fDebuggeeThread.stepDebug(fViewInformation,asyncRequest());
