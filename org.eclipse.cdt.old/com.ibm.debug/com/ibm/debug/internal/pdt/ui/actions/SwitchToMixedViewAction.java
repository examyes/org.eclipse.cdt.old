...
//
// com/ibm/debug/internal/pdt/ui/actions/SwitchToMixedViewAction.java, eclipse, eclipse-dev, 20011128
// Version 1.4 (last modified 11/28/01 15:59:13)
////////////////////////////////////////////////////////////////////////////////
...
public class SwitchToMixedViewAction extends SwitchViewBaseAction {

	/**
	 * Constructor for SwitchToDisViewAction
	 */
	protected SwitchToMixedViewAction() {
		super();
	}
	 ...
	 * Constructor for SwitchToDisViewAction
	 */
	protected SwitchToMixedViewAction(String arg0) {
		super(arg0);
	}
	 ...
	 * Constructor for SwitchToDisViewAction
	 */
	protected SwitchToMixedViewAction(String arg0, ImageDescriptor arg1) {
		super(arg0, arg1);
	}
	...
	public void run() {
		if (stackFrame != null)
		{
			...
			ViewInformation viewInfo = pdt.getDebugEngine().getMixedViewInformation();
