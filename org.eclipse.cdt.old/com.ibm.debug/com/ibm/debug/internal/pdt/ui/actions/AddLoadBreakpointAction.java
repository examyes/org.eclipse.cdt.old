...
//
// com/ibm/debug/internal/pdt/ui/actions/AddLoadBreakpointAction.java, eclipse, eclipse-dev, 20011128
// Version 1.9 (last modified 11/28/01 15:58:14)
////////////////////////////////////////////////////////////////////////////////
...
public class AddLoadBreakpointAction extends AbstractOpenWizardWorkbenchAction implements IViewActionDelegate, ISelectionListener  {

	IAction myAction;

	/**
	 * Constructor for AddLoadBreakpointAction
	 */
	public  AddLoadBreakpointAction(){
		super();
	 ...
	 * Constructor for AddLoadBreakpointAction
	 */
	public AddLoadBreakpointAction(IWorkbench workbench, String label, Class[] acceptedTypes) {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection sel) {
		...
		if (element instanceof PICLDebugElement && !((IDebugElement)element).getDebugTarget().isTerminated()
			&& ((PICLDebugTarget)((IDebugElement)element).getDebugTarget()).supportsBrkptType(IPICLDebugConstants.PICL_LOAD_BREAKPOINT))
		...
		else if (element instanceof ILaunch) //launcher
		{
			...
			if (dt instanceof PICLDebugTarget && !((PICLDebugTarget)dt).isTerminated()
				&& ((PICLDebugTarget)dt).supportsBrkptType(IPICLDebugConstants.PICL_LOAD_BREAKPOINT))
				myAction.setEnabled(true);
