...
//
// com/ibm/debug/internal/pdt/ui/actions/PrintStorageToolbarAction.java, eclipse, eclipse-dev, 20011128
// Version 1.2 (last modified 11/28/01 16:01:25)
////////////////////////////////////////////////////////////////////////////////
...
public class PrintStorageToolbarAction extends Action {
	...
	/**
	 * Constructor for PrintStorageToolbarAction
	 */
	public PrintStorageToolbarAction(String pJobTitle) {
	...
	public void run() {
		...
		if (storageTab != null) {
			...
			if (tableViewer != null) {
				PrintTableViewAction fPrintTableViewAction = new PrintTableViewAction(tableViewer, printJobTitle);
				fPrintTableViewAction.run();
			}
		}
	}
