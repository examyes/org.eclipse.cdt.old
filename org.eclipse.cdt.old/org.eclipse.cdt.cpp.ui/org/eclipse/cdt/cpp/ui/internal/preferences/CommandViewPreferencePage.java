...
public class CommandViewPreferencePage extends PreferencePage implements IWorkbenchPreferencePage
{
    private ViewPreferenceControl _control;
    public CommandViewPreferencePage() 
    {
    }
    ...
    {
	String property = new String("CommandViewFont");
    ...
    {
	readColour("CommandViewBackground", _control.getColour1(), true);
	readColour("CommandViewForeground", _control.getColour2(), false);
	readFont();
    }

    public boolean performOk()
    {
	writeColour("CommandViewBackground", _control.getColour1());
	writeColour("CommandViewForeground", _control.getColour2());
	writeFont();
