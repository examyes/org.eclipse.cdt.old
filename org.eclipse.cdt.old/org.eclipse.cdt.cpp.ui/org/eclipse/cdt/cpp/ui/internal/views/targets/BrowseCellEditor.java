 ...
 * Creation date: (1/18/01 4:11:00 PM)
...
/**
 * This hook is called to create the button display on the right hand
 * side of the dialog cell editor.
 */
...
/**
 * Hook called when the user has pressed the button and the dialog
 * box must pop up.
 * @param cellEditorWindow The cell editor's window so that subclasses
