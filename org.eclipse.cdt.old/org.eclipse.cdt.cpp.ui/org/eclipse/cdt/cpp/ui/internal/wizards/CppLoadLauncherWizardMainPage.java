...
public class CppLoadLauncherWizardMainPage extends WizardPage implements Listener
{
...
//    private  boolean       _debugInitialization;
     ...
     */
    public CppLoadLauncherWizardMainPage(String pageId, String currentSelectionName, DataElement directory) {
	super(pageId);
...
/*
    protected void createDebugInitializationGroup(Composite parent)
    {
   	...
   	GridLayout layout = new GridLayout();
   	layout.numColumns = 3;
   	debugInitializationGroup.setLayout(layout);
   	debugInitializationGroup.setLayoutData(
   					   new GridData(GridData.HORIZONTAL_ALIGN_FILL | GridData.GRAB_HORIZONTAL));
   	
   	


   	debugInitialization = new Button(debugInitializationGroup, SWT.CHECK);
   	debugInitialization.setText(_plugin.getLocalizedString("debugLauncherMain.DebugInitialization"));
   	debugInitialization.setSelection(false);
   	...
   	debugInitialization.setLayoutData(dD);

   	debugInitialization.setEnabled(true);
