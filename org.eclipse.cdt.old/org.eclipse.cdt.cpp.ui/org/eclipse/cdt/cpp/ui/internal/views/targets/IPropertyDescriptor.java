 ...
 *
 * @return the help context ids, or <code>null</code> if this property has no
 *   help contexts
 */
public Object getHelpContextIds();
/**
 * Returns the id for this property. This string is not shown to the user; it is
 * used internally to distinguish one property descriptor from another.
 *
