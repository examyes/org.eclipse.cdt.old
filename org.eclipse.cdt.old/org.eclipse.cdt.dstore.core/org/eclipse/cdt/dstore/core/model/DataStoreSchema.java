...
public class DataStoreSchema
{
	...
	public void extendSchema(DataElement schemaRoot)
	{
		...
		DataElement cancellable = _dataStore.createAbstractObjectDescriptor(schemaRoot, getLocalizedString("model.Cancellable"));
		...
		// file objects
		DataElement deviceD = _dataStore.createObjectDescriptor(schemaRoot, getLocalizedString("model.device"), "org.eclipse.cdt.dstore.miners");
		DataElement fileD = _dataStore.createObjectDescriptor(schemaRoot, getLocalizedString("model.file"), "org.eclipse.cdt.dstore.miners");
		DataElement dirD = _dataStore.createObjectDescriptor(schemaRoot, getLocalizedString("model.directory"), "org.eclipse.cdt.dstore.miners");
		...
		DataElement hostsDetails = _dataStore.createAbstractObjectDescriptor(schemaRoot, getLocalizedString("model.Hosts"));

		_dataStore.createReference(rootD, hostsDetails);
