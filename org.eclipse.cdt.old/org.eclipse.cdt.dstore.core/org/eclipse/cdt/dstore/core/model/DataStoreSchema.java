...
public class DataStoreSchema
{
	...
	DataElement minerDetails = _dataStore.createAbstractObjectDescriptor(minerD, getLocalizedString("model.Miner_Details"));
	_dataStore.createReference(minerDetails, allD, containsD);

        DataElement hostsDetails = _dataStore.createAbstractObjectDescriptor(rootD, getLocalizedString("model.Hosts"));	
	_dataStore.createReference(hostsDetails, rootD, containsD);	
	_dataStore.createReference(hostsDetails, hostD, containsD);	
	_dataStore.createReference(hostsDetails, deviceD, containsD);	
	_dataStore.createReference(hostsDetails, dirD, containsD);	

        DataElement rootDetails = _dataStore.createAbstractObjectDescriptor(rootD, getLocalizedString("model.Details"));	
	_dataStore.createReference(rootDetails, rootD, containsD);	
	_dataStore.createReference(rootDetails, minersD, containsD);	
	_dataStore.createReference(rootDetails, minerD, containsD);	

        DataElement minerObjects = _dataStore.createAbstractObjectDescriptor(rootD, getLocalizedString("model.Tools"));
        _dataStore.createReference(minerObjects, minersD, containsD);
        _dataStore.createReference(minerObjects, minerD, containsD);
	_dataStore.createReference(minerObjects, dataD, containsD);	
	_dataStore.createReference(minerObjects, stateD, containsD);	
	
        DataElement schemaDetails = _dataStore.createAbstractObjectDescriptor(rootD, getLocalizedString("model.Schema"));
        _dataStore.createReference(schemaDetails, objectDescriptor, containsD);
