...
public final class Parser implements ParserConstants {
 ...
 public boolean jumpToClosingCurly()
 {
  ...
  Token tok = token_source.jumpPastBadTokens();
...
//Fix this according to the C++ standard!!!
 ...
 String name = ""; String next = ""; int startLine = getToken(1).beginLine;
    ...
    case IF:
      ...
      name = expression();
      jj_consume_token(CLOSEPAREN);
                                     symtab.addObject(ParserSchema.dStatement, "if ( " + name + " )", startLine,true);
      statement();
                symtab.closeScope();
      if (jj_2_62(2147483647)) {
        jj_consume_token(ELSE);
             symtab.addObject(ParserSchema.dStatement, "else", getToken(0).beginLine,true);
        statement();
                 symtab.closeScope();
      } else {
        ;
 ...
 String name = ""; String next = ""; int startLine = getToken(1).beginLine; DataElement theObject;
    ...
    theObject = symtab.addObject(ParserSchema.dStatement, "do", startLine,true);
      ...
      jj_consume_token(CLOSEPAREN);
      jj_consume_token(SEMICOLON);
    theObject.setAttribute(DE.A_NAME, "do...while (" + name + ")");
      break;
    case FOR:
...
//The opening quote has already been matched when we get here:
  ...
  final private int[] jj_la1_0 = {0x80000000,0x80000000,0x80000000,0x0,0x80000000,0x80000000,0x0,0x80000000,0x0,0x0,0x80000000,0x80000000,0x40000000,0xa0000000,0x2000000,0x80000000,0x40000000,0xa0000000,0x2000000,0x80000000,0x82000000,0x0,0x0,0x80000000,0x0,0x80000000,0x2000000,0x0,0xa8000000,0xa2000000,0x2000001,0x0,0xe0000000,0xa2000000,0x20000000,0xa8000000,0xa8000000,0x8000000,0xa0000000,0x20000000,0x28000000,0x0,0x0,0x80000000,0x0,0x0,0x0,0x2000000,0x2000000,0x0,0x0,0x2000000,0x0,0x0,0x0,0x2000000,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x2000001,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x0,0x2000000,0x0,0x80000000,0x20000000,0x0,0x0,0x80000000,0x0,0xa0000000,0x8000000,0x28000000,0x8000000,0x20000000,0x28000000,0x80000000,0x0,0x80000000,0x0,0xa0000000,0x80000000,0x2000000,0x80000000,0x0,0xa2000000,0x0,0x0,0x80000000,0x0,0xa0000000,0x0,0x0,0x0,0x80000000,0xa0000000,0xa0000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xa0000000,0xa0000000,0x0,0xa0000000,0x0,0x20000000,0x28000000,0x20000000,0x80000000,0x80000000,0xa0000000,0xe0000000,0x8000000,0x20000000,0x80000000,0x8000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x80000000,0xa0000000,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x80000000,0x0,};
  final private int[] jj_la1_1 = {0x80100002,0x81100010,0x80900002,0x0,0x0,0x80100002,0x0,0x0,0x0,0x80100000,0x0,0x0,0x0,0xe0100000,0x23,0x0,0x0,0xe0100000,0x23,0x80100002,0x80100002,0x20,0x0,0x0,0x0,0x0,0x0,0x22,0x80100000,0xe0100002,0x0,0x4,0xe0100000,0xe0100000,0x20,0x0,0x0,0x0,0xe0100000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x0,0x0,0x1,0x2,0x0,0x1,0x2,0x0,0x4,0x0,0x0,0x0,0x0,0x0,0x80100002,0x80100002,0x80100002,0x4,0x0,0x21,0x21,0x0,0x4,0x20,0x80100000,0x0,0x0,0x0,0x0,0x3,0x0,0x4,0x0,0x0,0x4,0x20,0x80100010,0x4,0xe0100000,0x0,0x80100000,0x0,0x0,0x0,0x80100010,0x4,0x80100010,0x4,0xe0100000,0x0,0x2,0x80100000,0x0,0xe0100002,0x0,0x2,0x80100000,0x0,0xe0100000,0x0,0x0,0x0,0x80100002,0xe0100000,0xe0100000,0xffe0,0x8,0x0,0x600000,0x7800000,0x18000000,0x60000000,0x80000000,0x0,0xe0100000,0xe0100000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80100000,0xe0100000,0x80100000,0x0,0x0,0x0,0xe0100000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe0100000,0x800000,0x0,0x80100000,0x60000000,0x80000,0x40000,0x1fe3ffe4,0x80100000,0x4,};
  final private int[] jj_la1_2 = {0x79072c00,0x19072800,0x79072c00,0x0,0x0,0x79072c00,0x20000,0x0,0x0,0x19072800,0x0,0x10,0x0,0x248003c,0x40000,0x10,0x0,0x248003c,0x40000,0x79072c00,0x79072c00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0