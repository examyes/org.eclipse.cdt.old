...
//The declaration_specifiers have already been matched when we get here:
 ...
 String name;
  isConstructor = (   (theTypes.indexOf(" ") == -1)
                   || ( (theTypes.lastIndexOf(" ") == theTypes.indexOf(" ")) && (theTypes.startsWith("inline")))
                  );
    if (jj_2_19(2)) {
