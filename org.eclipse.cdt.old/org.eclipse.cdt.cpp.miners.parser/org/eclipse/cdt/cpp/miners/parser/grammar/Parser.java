...
public final class Parser implements ParserConstants {
 ...
 public String[] parseDeclaration(String theTypes, boolean pointerInType)
 {
  ...
  {
   theArray[0] = theTypes.substring(division, theTypes.length()).trim();
   theArray[1] = theTypes.substring(0, division).trim();
  }
  return theArray;
 }
 ...
 String theTypes = empty;
    ...
    case SEMICOLON:
      jj_consume_token(SEMICOLON);
          symtab.setCurrentDeclaration(null); symtab.setObjectTypedef(false);
      break;
    case SCOPE:
    case AMPERSAND:
    case STAR:
    ...
    case ID:
      ...
      if (jj_2_1(2147483647)) {
        function_definition(theTypes, null);
      } else {
        simple_declaration(theTypes);
      }
      break;
    case OPENPAREN:
      function_pointer_without_return_type();
      break;
    default:
      jj_la1[5] = jj_gen;
      jj_consume_token(-1);
...
//This matches a function pointer without return type (e.g. (*fpt)(int, void*)).
  final public void function_pointer_without_return_type() throws ParseException {
 String name = empty; String type = empty;
    jj_consume_token(OPENPAREN);
    jj_consume_token(STAR);
    name = extended_identifier();
    jj_consume_token(CLOSEPAREN);
    jj_consume_token(OPENPAREN);
    type = parameter_list(false);
    jj_consume_token(CLOSEPAREN);
    jj_consume_token(SEMICOLON);
  name = "(*)(" + type + ")" + " " + name;
 ...
 String name = null, next; DataElement classDecl = null; boolean semicolonFound = false;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case CLASS:
    case STRUCT:
    case UNION:
      ...
      if (jj_2_3(2147483647)) {
        classDecl = class_specifier();
                if (classDecl != null) {name += " " + classDecl.getName(); symtab.setCurrentDeclaration(classDecl);}
      } else {
        ;
      }
      if (jj_2_4(2147483647)) {
        jj_consume_token(SEMICOLON);
                                   semicolonFound = true; symtab.setCurrentDeclaration(null);
      } else {
        ;
      }
    ...
    case TYPEDEF:
      jj_consume_token(TYPEDEF);
                 symtab.setObjectTypedef(true); name = empty;
      break;
    case TYPENAME:
...
//The declaration_specifiers have already been matched when we get here:
  final public void function_definition(String theTypes, String className) throws ParseException {
 String name, next=null;
    // If we have a class name, then the function is a constructor if the function name
    // is the same as the class name plus an optional "inline" prefix.
    if (className != null && className.length() > 0)
     isConstructor = theTypes.equals(className) || theTypes.equals("inline " + className);
    else
    {
     // Try to find "::" if the class name is not given.
     int index = theTypes.lastIndexOf("::");
     if (index > 0)
      isConstructor = theTypes.substring(0, index).equals(theTypes.substring(index+2)) ||
                      theTypes.substring(0, index).equals("inline " + theTypes.substring(index+2));
     else
      isConstructor = false;
    }
    if (jj_2_22(2)) {
      ...
      case ID:
        if (jj_2_20(3)) {
          next = extended_identifier();
        } else {
          ;
        }
        name = declarator(ParserSchema.Function);
      DataElement theFunction = null;
      if (symtab.isObjectTypedef())
      {
       if (next != null)
        name = theTypes + " ()" + name + " " + next;
       else
       {
        int lastSpace = theTypes.lastIndexOf(' ');
        if (lastSpace > 0)
         name = theTypes.substring(0, lastSpace) + " ()" + name + " " + theTypes.substring(lastSpace+1);
        else
         name = "()" + name + " " + theTypes;
       }
       symtab.addObject(ParserSchema.dVariable, name, getToken(0).beginLine, false);
       symtab.setObjectTypedef(false);
      }
      else
      {
       if (next !=null)
       ...
       theFunction = symtab.addObject(funcType, names[0], name, getToken(0).beginLine, true);
      }
        if (jj_2_21(2)) {
          jj_consume_token(SEMICOLON);
                           symtab.closeScope();
...
//This method returns a bool indicating whether a class DataElement was created or not.
  final public DataElement class_specifier() throws ParseException {
 String classType = empty; String name = empty; DataElement theClass = null; int startLine = getToken(1).beginLine;
  ...
  final public void class_body(String className) throws ParseException {
    jj_consume_token(OPENCURLY);
    if (jj_2_38(1)) {
      member_declaration_list(className);
    } else {
      ;
    }
    jj_consume_token(CLOSECURLY);
  ...
  final public void member_declaration_list(String className) throws ParseException {
    label_10:
    while (true) {
      member_declaration(className);
      if (jj_2_39(1)) {
        ;
      } else {
        break label_10;
  ...
  final public void member_declaration(String className) throws ParseException {
 String theTypes = empty;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case PUBLIC:
      jj_consume_token(PUBLIC);
     ...
     if (theTypes == null)
      {if (true) return;}
          if (jj_2_40(2147483647)) {
            function_definition(theTypes, className);
          } else {
...
//The declaration_specifiers have already been matched when we get here
 ...
 String name = empty; int startLine = getToken(1).beginLine; boolean firstTime = true;
    if (jj_2_42(2)) {
      ...
      case COLON:
        jj_consume_token(COLON);
        name = constant();
                             name = UnnamedTypeManager.instance().getNextBitfield() + ":" + name;
        break;
      default:
        jj_la1[61] = jj_gen;
        jj_consume_token(-1);
 ...
 String name = empty; String value = empty; int startLine = getToken(1).beginLine;
    identifier();
                name = getToken(0).image;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ASSIGNEQUAL:
...
//The declaration_specifiers have already been matched when we get here:
 ...
 String fullName = empty; int startLine = getToken(1).beginLine;
   ...
   //Weed out the inline specifier if it exists:
 ...
 String name = empty; String next = empty;
    ...
    if (addTypes && parameterLevel < 2) symtab.addFunctionParameter(name);
    label_14:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COMMA:
      ...
      next = parameter_declaration();
                                        if (addTypes && parameterLevel < 2) symtab.addFunctionParameter(next); name += "," + next;
    }
    parameterLevel--; {if (true) return name;}
    throw new Error("Missing return statement in function");
  }
...
//Fix this according to the C++ standard!!!
 ...
 String name;
  ...
  final public String extended_identifier() throws ParseException {
 String name;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case OPENPAREN:
      jj_consume_token(OPENPAREN);
 ...
 String name = getToken(1).image;
  ...
  final public void exception_spec() throws ParseException {
    ...
    case THROW:
      ...
      break;
    case THROWMACRO2:
      jj_consume_token(THROWMACRO2);
      break;
    case THROWMACRO:
      jj_consume_token(THROWMACRO);
      break;
    default:
      jj_la1[153] = jj_gen;
      jj_consume_token(-1);
...
//The opening quote has already been matched when we get here:
  ...
  final private boolean jj_3R_225() {
    if (jj_scan_token(THROWMACRO)) return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
    return false;
  }
  ...
  final private boolean jj_3R_224() {
    if (jj_scan_token(THROWMACRO2)) return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
    return false;
  }
  ...
  final private int[] jj_la1_0 = {0xa0000000,0x80000000,0xa0000000,0x0,0x80000000,0xa0000000,0x0,0x80000000,0x0,0x0,0x80000000,0x80000000,0x40000000,0xa0000000,0x2000000,0x40000000,0xa0000000,0x2000000,0xa0000000,0xa2000000,0x0,0x0,0xa0000000,0x2000000,0x80000000,0x0,0x80000000,0x2000000,0xa8000000,0xa2000000,0x2000001,0x0,0xe0000000,0xa2000000,0x20000000,0xa8000000,0xa8000000,0x8000000,0xa0000000,0x20000000,0x28000000,0x0,0x80000000,0x0,0x0,0x0,0x2000000,0x0,0x0,0x2000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x