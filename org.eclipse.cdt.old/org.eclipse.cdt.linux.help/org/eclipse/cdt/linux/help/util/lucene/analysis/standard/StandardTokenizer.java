 ...
 */
public class StandardTokenizer extends com.ibm.linux.help.util.lucene.analysis.Tokenizer implements StandardTokenizerConstants {
 ...
 */
  final public com.ibm.linux.help.util.lucene.analysis.Token next() throws ParseException, IOException {
  Token token = null;
    ...
    default:
      ...
      if (token.kind == EOF) {
        ...
        {if (true) return
          new com.ibm.linux.help.util.lucene.analysis.Token(token.image,
