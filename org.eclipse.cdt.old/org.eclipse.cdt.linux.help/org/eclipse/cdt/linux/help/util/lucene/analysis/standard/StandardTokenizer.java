 ...
 */
public class StandardTokenizer extends org.eclipse.cdt.linux.help.util.lucene.analysis.Tokenizer implements StandardTokenizerConstants {
 ...
 */
  final public org.eclipse.cdt.linux.help.util.lucene.analysis.Token next() throws ParseException, IOException {
  Token token = null;
    ...
    default:
      ...
      if (token.kind == EOF) {
        ...
        {if (true) return
          new org.eclipse.cdt.linux.help.util.lucene.analysis.Token(token.image,
  ...
  final private int[] jj_la1_0 = {0xff,};
