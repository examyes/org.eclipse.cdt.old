...
package org.eclipse.cdt.linux.help.util.lucene.queryParser;
...
public class QueryParser implements QueryParserConstants {
  ...
  private Query getFieldQuery(String field, Analyzer analyzer, String queryText) {
    ...
    Vector v = new Vector();
    org.eclipse.cdt.linux.help.util.lucene.analysis.Token t;
  ...
  public static void main(String[] args) throws Exception {
    QueryParser qp = new QueryParser("field",
                                     new org.eclipse.cdt.linux.help.util.lucene.analysis.SimpleAnalyzer());
...
// *   Clause ::= ["+", "-"] [<TERM> ":"] ( <TERM> | "(" Query ")" )
  ...
  final private int[] jj_la1_0 = {0xc00,0xc00,0x7000,0x7000,0x770fc00,0x7708000,0x1600000,0x880000,0x880000,0x40000,0x6000000,0x7700000,};
