...
public class SearchDictionaryAction extends CustomAction
{
    private HostsPlugin _plugin;

    public SearchDictionaryAction(DataElement subject, String label, DataElement command, DataStore dataStore)
    {	
