...
//
// com/ibm/debug/gdb/GdbDebugSession.java, gdb, java-dev
// Version 1.1 (last modified 5/24/01 13:41:50)   (based on Jde 6/2/98 1.101)
///////////////////////////////////////////////////////////////////////
...
public class GdbDebugSession extends DebugSession
{
  ...
  public  GdbProcess getGdbProcess() { return gdbProcess; }
  ...
  public  void   setCurrentFileLineModule(String currentLineNumber, String currentFileName, String currentFunctionName,
                    String currentFrameAddress, int currentModuleID, String currentModuleName, int currentPartID )
  {  _currentLineNumber = currentLineNumber; _currentFileName = currentFileName; _currentFunctionName = currentFunctionName;
     _currentFrameAddress = currentFrameAddress; _currentModuleID = currentModuleID; _currentModuleName = currentModuleName; _currentPartID = currentPartID;
  }
  ...
  private void updateSharedLibraries()
  {
     ...
     if(moduleInfo!=null)
     {
        ...
        if(moduleInfo[i]!=null)
        {
           ...
           _moduleManager.setModuleStartFinishAddress(moduleInfo[i].name, moduleInfo[i].startAddress, moduleInfo[i].endAddress);
        }
     }
  }
...
//     addChangesToUiMessages();
  ...
  public void cmdExamineException(String threadName)
  {
     ...
     {
         _whyExceptionMsg = getResourceString("CANNOT_RETRY_EXCEPTION_MUST_RUN_OR_TERMINATE");
        _whyStop = WS_ExceptionThrown;
        return;
     }
  ...
  public String exceptionName()
  {
   ...
   public    void   setDataAddress(String dataAddress) { _dataAddress = dataAddress; }
