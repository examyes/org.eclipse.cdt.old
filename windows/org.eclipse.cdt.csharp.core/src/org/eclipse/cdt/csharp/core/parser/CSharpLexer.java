...
public class CSharpLexer extends LpgLexStream implements CSharpParsersym, CSharpLexersym, RuleAction
{
    private static ParseTable prs = new CSharpLexerprs();
    ...
    public CSharpLexer(String filename, int tab) throws java.io.IOException 
    {
        super(filename, tab);
    }

    public CSharpLexer(char[] input_chars, String filename, int tab)
    {
        super(input_chars, filename, tab);
    }

    public CSharpLexer(char[] input_chars, String filename)
    {
    ...
    public String[] orderedExportedSymbols() { return CSharpParsersym.orderedTerminalSymbols; }
    ...
    //
    CSharpKWLexer kwLexer;
    boolean printTokens;
    private final static int ECLIPSE_TAB_VALUE = 4;

    public int [] getKeywordKinds() { return kwLexer.getKeywordKinds(); }

    public CSharpLexer(String filename) throws java.io.IOException
    {
        this(filename, ECLIPSE_TAB_VALUE);
        this.kwLexer = new CSharpKWLexer(getInputChars(), TK_IDENTIFIER);
    }

    public CSharpLexer(Option option) throws java.io.IOException
    {
